...
public class UdpGetClientMacAddrUtil {

    private static Log log = LogFactory.getLog(UdpGetClientMacAddrUtil.class);
    ...
    public UdpGetClientMacAddrUtil(String strAddr) throws Exception {
        remoteAddr = strAddr;
...
//        UdpGetClientMacAddr add = new UdpGetClientMacAddr("10.63.74.96");
        UdpGetClientMacAddrUtil add = new UdpGetClientMacAddrUtil("10.63.74.96");
