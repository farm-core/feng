...
public class TransactionAdviceConfig {
     ...
     * 配置方法过期时间，默认-1,永不超时
     */
    private final static int TX_METHOD_TIME_OUT = 20;
     ...
     */
    private static final String POITCUT_EXPRESSION = "execution(* com.yun.admin.service.impl.*.*(..))";
    @Autowired
